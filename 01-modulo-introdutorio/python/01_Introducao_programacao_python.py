...
receita = pd.read_csv("02_receita_empresas.csv")
...
dataset_2.to_csv("dataset2.xlsx", index=False)
...
# Carregar o arquivo com o parâmetro 'quotechar' para ignorar as aspas internas
pisa = pd.read_csv("(2) notas_pisa.csv", quotechar='"', skipinitialspace=True)
...
pisa_ocde = pisa.drop(pisa.index[3:27])
...
comercio = pd.read_csv("(2)comercio_global.csv", sep=";")

print(comercio.head(5))
